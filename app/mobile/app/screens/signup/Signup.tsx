  ...
  return (
    <View className="flex-1 items-center justify-center bg-white">
      <View className=" w-[80%] bg-secondary-background p-12 rounded-lg flex items-center ">
        <Text className="text-4xl font-bold font-bricolage">Sign Up</Text>
        <Text className="text-md text-gray-500">
          Wellness starts with tracking
        </Text>
        ...
        <View className="text-xs mt-3 flex-row h-10">
          ...
          <Text className="text-primary h-3">
            <TouchableOpacity onPress={() => navigation.navigate('Signin')} className="h-10">
                <Text className="h-10 text-primary"> Sign In</Text>
            </TouchableOpacity>
          </Text>
        </View>
      </View>
